...
/**
 * Created by zephyre on 5/26/15.
 */
case class ApiumSeedBuilder(task: String, args: Option[Seq[JsonNode]] = None, kwargs: Option[Map[String, JsonNode]] = None,
                        expire: Option[DateTime] = None, eta: Option[DateTime] = None,
